...
add wave -noupdate -expand -group {AHB read} /ahb_fifo_read_tb/arif/rdata
...
add wave -noupdate -expand -group WPTR /ahb_fifo_read_tb/FIFO/wpif/sync_rptr
add wave -noupdate -expand -group WPTR /ahb_fifo_read_tb/FIFO/wpif/wptr
add wave -noupdate -expand -group WPTR /ahb_fifo_read_tb/FIFO/wpif/waddr
